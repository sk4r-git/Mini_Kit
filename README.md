...
## permettre depuis la gui de faire un choix sur proc et files
## reduire scope a l'interieur pour se concentrer que la dessus
## permettre vrai hook sur ces proc/files en permettant a luser de valider l'rw et/ou de modifier ce qui passe
